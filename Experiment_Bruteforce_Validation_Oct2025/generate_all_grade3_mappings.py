...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('generate_all_grade3_mappings.log'),
...
def main():
    ...
    CSV_FILE = "/workspaces/github-com-anirudhs-ti-edullm-experiments/data/curricululm_with_assesment_boundary.csv"
    DI_FORMATS_FILE = "/workspaces/github-com-anirudhs-ti-edullm-experiments/data/di_formats_with_mappings.json"
    OLD_MAPPINGS_FILE = "/workspaces/github-com-anirudhs-ti-edullm-experiments/output/substandard_to_sequence_mappings.json"
    OUTPUT_FILE = "/workspaces/github-com-anirudhs-ti-edullm-experiments/output/substandard_to_sequence_mappings.v3.json"
    TEMP_FILE = "/workspaces/github-com-anirudhs-ti-edullm-experiments/output/substandard_to_sequence_mappings.v3.json.tmp"
    REPORT_FILE = "/workspaces/github-com-anirudhs-ti-edullm-experiments/output/bruteforce_remap_report_all_grade3.md"
